...
void Menu :: crearUsuario()
{
  ...
  if(escritura.is_open()&&verificador.is_open())
  {
        ...
        do
        {
            ...
            {
                getline(verificador,usuario.contrasena);
        ...
        case 'D': 
          {
            crearAdmin();
            escritura<<usuario.codigo<<endl<<usuario.contrasena<<endl<<usuario.nombres<<endl<< usuario.apellidos <<endl << usuario.dni<<endl << usuario.correoInsti<<endl<<usuario.celular<< endl<<usuario.direccion<<endl<<usuario.estdCiv<<endl;
          }
        case 'P': 
          {
            crearProf();
            escritura<<usuario.codigo<<endl<<usuario.contrasena<<endl<<usuario.nombres<<endl<< usuario.apellidos <<endl << usuario.dni<<endl << usuario.correoInsti<<endl<<usuario.celular<< endl<<usuario.direccion<<endl<<usuario.estdCiv<<endl<<profesor.cursosEnsena<<endl<<profesor.sueldo<<endl<<profesor.perfilProf<<endl<<profesor.suplente;
          }
        case 'A': 
          {
            crearAlumno();
            escritura<<usuario.codigo<<endl<<usuario.contrasena<<endl<<usuario.nombres<<endl<< usuario.apellidos <<endl << usuario.dni<<endl << usuario.correoInsti<<endl<<usuario.celular<< endl<<usuario.direccion<<endl<<usuario.estdCiv<<endl<<alumno.carrera<<endl<<alumno.cursos<<endl<<alumno.periodoIngreso<<endl<<alumno.semestre<<endl<<alumno.creditosSemestre<<endl<<alumno.creditosAcumulados<<endl<<alumno.notas<<endl<<alumno.mensualidad;
          }
        }
      ...
      if(auxCodigo== usuario.codigo)
        {
          ...
          cout<<"\n\nRegistro Encontrado\n\n";
          cout<<"Código: "<<usuario.codigo<<endl;
          cout<<"Cursos que ensena: "<<usuario.nombres<<endl;
